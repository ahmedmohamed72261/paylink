    ...
    <footer className="bg-gray-900 text-white py-16 px-4 border-t border-gray-800">
      <div className="container mx-auto">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold text-white">PayLink</span>
                <span className="text-xs text-gray-400 -mt-1">روابط الدفع الذكية</span>
              </div>
            </div>
            <p className="text-gray-400 mb-4">الحل الأمثل لقبول المدفوعات الإلكترونية بسهولة وأمان في منطقة الخليج</p>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 mb-4 md:mb-0">© 2024 PayLink. جميع الحقوق محفوظة.</p>
